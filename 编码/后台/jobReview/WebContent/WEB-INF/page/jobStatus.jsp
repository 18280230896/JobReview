...
<input value="${classTask.type}" class="hidden" id="type">
<input value="${classTask.c.id}" class="hidden" id="classId">
<!--导航-->
...
<div class="container">
	<div class="row">
		<div class="col-md-12">
			<h3 class="page-header">任务提交情况一览表</h3>
		</div>
	</div>
	<div class="row">
		<div class="col-md-12">
...
<script src="js/jobStatusPaging.js"></script>
</body>
</html>