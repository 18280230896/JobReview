...
public class WorkServiceImpl implements WorkService {
	...
	public void addWork(Work work) {
		...
		if(work.getStudent() != null){
			Class c = classMapper.getClassById(studentMapper.getStudentById(work.getStudent().getId()).getC().getId());
			...
			Class c = classMapper.getClassById(groupMapper.getGroupById(work.getGroup().getId()).getC().getId());
			classTask = classTaskMapper.getClassTaskByTCId(task.getId(), c.getId());
