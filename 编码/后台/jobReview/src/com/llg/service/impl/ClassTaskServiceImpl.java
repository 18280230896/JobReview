...
public class ClassTaskServiceImpl implements ClassTaskService {
	...
	@Override
	public List<ClassTask> getClassTaskByType(Integer classId, Integer type,Integer semester) {
		return classTaskMapper.getClassTaskAllByType(classId, type,semester);
	}
